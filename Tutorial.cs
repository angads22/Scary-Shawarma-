...
namespace ScaryShawarmaGame
{
	public static class Tutorial
	{
		public static void StartTutorial()
		{
			...
			// Using standard WriteLine here so the text instantly flashes onto the screen
			...
			Console.ForegroundColor = ConsoleColor.DarkGreen;
			Console.WriteLine("Failing to fulfill an order correctly will directly");
			Console.WriteLine("impact your metrics.");
...
|___/  \____/\_| |_/\_/ \_| |_/
		");
			...
			TypeWriter("You can also close the service window, though that may not always help...");
			Thread.Sleep(2000);
